...
var InitMain= function () {
	...
	loadTextResource('./main.vs', function (vsErr, vsText) {
		if (vsErr) {
			alert('Fatal error getting vertex shader (see console)');
			console.error(vsErr);
		} else {
			loadTextResource('./main.fs', function (fsErr, fsText) {
				if (fsErr) {
					alert('Fatal error getting fragment shader (see console)');
					console.error(fsErr);
				} else {
          console.log('Loaded Files');
					RunMain(vsText, fsText);
				}
		});
  }
 });
...
//Starts up webGL
var RunMain = function (vertexShaderText, fragmentShaderText) {
	...
	gl.frontFace(gl.CCW);
	gl.cullFace(gl.BACK);
  console.log('Enabled webGL');

	// Create shaders mainShaders
